...
#     --vocab_path save/models/mlqa_topic_models/labse/french_vietnamese/ctm_new_vocab_20k.pkl \
#     --data_preparation_file save/models/mlqa_topic_models/labse/french_vietnamese/data_cache.pkl \
#     --model_path_prefix save/models/mlqa_topic_models/labse/french_vietnamese/ctm_20k_topics_ \
#     --output_path save/models/mlqa_topic_models/labse/french_vietnamese/ctm_20k_topics_NCLUSTER/DATASET_ctm_20k_topics_ \
