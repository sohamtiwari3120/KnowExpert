DATA_PATH=./data_mlqa/
TOPIC_PATH=./save/models/mlqa_topic_models/french_vietnamese
OUTPUT_PATH=./save/mlqa_models/french_vietnamese
INDEX=$1
...
--tm True \
--load_topic \
--cluster_path $TOPIC_PATH/ctm_20k_topics_9/mlqa_ctm_20k_topics_9.npy \
--index $INDEX \
--tok gpt2 \
